            ...
            <div class="rounded-xl bg-white shadow-sm">
                <div class="p-6 text-gray-900">
                    <form method="GET" action="{{ route('relatorios.index') }}" class="space-y-4">
                        ...
                        <div class="nf-filter-grid">
                            <div class="nf-primary-search">
                                ...
                                <input
                                    ...
                                    placeholder="Código, nome, protocolo, prenotação, contrato, comarca ou UF"
                        ...
                        <details class="nf-advanced-filters" @if (collect($filtros)->filter(fn ($valor, $chave) => ! in_array($chave, ['busca_geral', 'tipo_status_id', 'tipo_substatus_id', 'pendente_faturamento']) && filled($valor))->isNotEmpty()) open @endif>
                        ...
                        <div class="nf-filter-actions">
                            ...
                            <button type="submit" formaction="{{ route('relatorios.exportar.excel') }}" class="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-emerald-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-600 sm:w-auto">
                            ...
                            <a href="{{ route('relatorios.index') }}" class="nf-btn-soft inline-flex w-full items-center justify-center rounded-lg px-4 py-2 text-sm font-semibold transition sm:w-auto">Limpar filtros</a>
                        </div>
                    </form>
                </div>
            </div>
